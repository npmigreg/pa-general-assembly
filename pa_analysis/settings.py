"""
Django settings for pa_analysis project.
...
ALLOWED_HOSTS = ['pa-generalassembly-gk.herokuapp.com']
...
WSGI_APPLICATION = 'pa_analysis.wsgi.application'
...
CELERY_WORKER_CONCURRENCY = 10 # If you tasks are CPU bound, then limit to the number of cores, otherwise increase substainally